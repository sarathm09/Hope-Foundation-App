 ...
 */
public class TransactionHistoryPrimaryFragment extends Fragment{
    ...
    public TransactionHistoryPrimaryFragment(){}

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frag_trans_manager_primary, container, false);
        initUi();
        return view;
    }
    ...
    private void initUi() {
        ...
        trList = (RecyclerView) view.findViewById(R.id.transaction_list_primary);

        trList.setLayoutManager(new LinearLayoutManager(context));
        trList.setHasFixedSize(true);
        Ion.with(this)
                .load("http://c4c.rootone.xyz/transaction_history.php?location=" + location + "&type=internal")
                .asJsonArray()
                .withResponse()
